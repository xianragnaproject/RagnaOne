...
| 7 | Go to **Payon** via Prontera Kafra Teleport Service | Base ≥ 15 **and** jobbed — **ends Phase 1** (`phase1Done` on arrival) |
...
AFK (step 5) picks a **random plaza tile** and a **random facing step** before sitting.

Phase 1 finale (step 7) never field-walks to Payon: Prontera → walk to Kafra → Teleport Service `c r2 c r2` → Payon.
